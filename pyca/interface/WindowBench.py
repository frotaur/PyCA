...
class WindowBench:
    ...
    def __init__(self,screen_size=(600, 800), world_size=(200,200), device="cpu", tablet_mode=False):
        ...
        self.fps=150 # Visualization FPS
        ...
        self.draw_steps = MultiToggle(states=["0", "1", "2", "3", "4", "5","6"], fract_position=(0.8, 0.5), fract_size=(0.15, 0.15),
                       state_bg_colors=[(100, 100, 100), (80, 80, 150), (60, 60, 200), (40, 40, 250), (20, 20, 250), (0, 0, 250), (0, 0, 250)])
    ...
    def draw_help(self):
        ...
        self.auto_label.text += f" Stopped : {self.stopped}"
        ...
        self.draw_steps._draw(self.screen)
    ...
    def _gui_events(self,event):
        ...
        self.draw_steps._handle_event(event)
